...
- Displays a random greeting every time you refresh the page.
...
```sh
  git clone https://github.com/Botlhale-Setou/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/Botlhale-Setou/hello-rails-back-end/issues).
